# from the nu_scripts repository
...
# View Git remotes of the current repository
export extern "git remote -v" []

# View Git remotes of the current repository
export extern "git remote --verbose" []

# Add Git remote to the local Git repository
...
# Rename a Git remote of the current repository
export extern "git remote rename" [
  old: string@"nu-complete git remotes"  # Old name of the renaming remote
  new: string                            # New name of the renaming remote
]

# Remove a Git remote from the current repository
export extern "git remote remove" [
  remote: string@"nu-complete git remotes"  # Name of the removing remote
]

# Get the URL of an remote of the current Git repository
export extern "git remote get-url" [
  --push
  --all                                         # Get url of the all given remotes names
  remote: string@"nu-complete git remotes"      # Name of the Git remote
]

# Set the URL of a current Git repository remote
export extern "git remote set-url" [
  remote: string@"nu-complete git remotes"  # Name of the changing URL remote
  url: string                               # New URL
]

# Give some information about the remote
export extern "git remote show" [
  remote: string@"nu-complete git remotes"  # Name of the showing remote
  -n                                        # Use cache
]

# Delete stale references associated with a given remote name
export extern "git remote prune" [
  remote: string@"nu-complete git remotes"  # Git remote
  --dry-run                                 # Report what branches would removed
]

export extern "git status" [
  --help(-h)                    # show the help message
  --short(-s)                   # show the short version of the git status
  --long                        # show the long version of the git status
  --show-stash                  # show the number of entries currently stashed away
  --untracked-files(-u)         # show untracked files
  --ignore                      # show the ignored files too
  --branch(-b):string@"nu-complete git branches" # view the status for a branch
]
